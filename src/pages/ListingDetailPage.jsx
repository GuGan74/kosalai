            ...
            <div className="det-layout">
                ...
                <div className="det-left">
                    ...
                    <div className="stats-grid">
                        ...
                        {listing.weight_kg && <div className="sg"><div className="lb">{t('listingDetail.weight')}</div><div className="vl">{listing.weight_unit === 'gram' ? `${Math.round(listing.weight_kg * 1000)} g` : `${listing.weight_kg} ${t('listingDetail.kg')}`}</div></div>}
