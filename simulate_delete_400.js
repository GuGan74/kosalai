...
async function run() {
  ...
  const currentUser = authData?.user || { id: "MOCK_USER_ID" };
  console.log('\n5. CURRENT USER:\n', currentUser);
  ...
  console.log('The token from getSession matched the Authorization header Bearer token.');

  // Triggering the bug
  // Simulating the onClick={deleteListing} bug where `id` evaluates to the event object
