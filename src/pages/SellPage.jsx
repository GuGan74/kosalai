...
export default function SellPage() {
    ...
    function validate() {
        ...
        else if (form.location.length > 30) errs.location = 'District name too long (max 30 characters)';
        ...
        else if (form.village.length > 20) errs.village = 'Village name too long (max 20 characters)';
        ...
        else if (form.taluk.length > 30) errs.taluk = 'Taluk name too long (max 30 characters)';
        ...
        if (form.landmark.length > 30) errs.landmark = 'Landmark too long (max 30 characters)';
